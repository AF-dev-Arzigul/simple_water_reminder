package uz.gita.waterReminder.views;
...
import uz.gita.waterReminder.SharedViewModel;
import com.yasinhajiloo.washhandsreminder2.databinding.FragmentAlarmEditorDialogBinding;
import uz.gita.waterReminder.constants.MySharedPreferenceConstants;
import uz.gita.waterReminder.constants.TimeConstants;
import uz.gita.waterReminder.utils.TimeDefinerString;
    ...
    private void setUpClickListeners() {
        mBinding.llOne.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                mSharedViewModel.setDataTime(TimeConstants.MIN);
